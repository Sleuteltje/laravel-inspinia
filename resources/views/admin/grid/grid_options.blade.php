...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li><a>Layout</a></li>
			<li class="active"><strong>Grid Opons</strong></li>
		</ol>
	</div>
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<p>Using a single set of
						<code>.col-md-*</code> 
						grid classes, you can create a default grid system that starts out stacked on mobile devices and tablet devices (the extra small to small range) 
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<p>Build on the previous example by creating even more dynamic and powerful layout with tablet
