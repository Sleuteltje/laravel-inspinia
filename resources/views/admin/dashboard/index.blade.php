				...
				<div class="col-lg-4">
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<h5>New data for the report</h5> <span class="label label-primary">CI+</span>
							...
							<div>
								<div class="feed-activity-list">
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/profile.jpg')}}"></a>
									...
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/a2.jpg')}}"></a>
										<div class="media-body ">
									...
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/a3.jpg')}}"></a>
										<div class="media-body ">
											<small class="pull-right">2h ago</small>
									...
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/a4.jpg')}}"></a>
										<div class="media-body ">
									...
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/a5.jpg')}}"></a>
										<div class="media-body ">
											<small class="pull-right">2h ago</small>
									...
									<div class="feed-element">
										<a href="profile.php" class="pull-left"><img alt="image" class="img-circle" src="{{asset('/assets/img/a7.jpg')}}"></a>
										<div class="media-body ">
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content inspinia-timeline">
							...
							<div class="timeline-item">
								<div class="row">
									<div class="col-xs-3 date">
										<i class="fa fa-user-md"></i>09:00 pm<br/>
							...
							<div class="timeline-item">
								<div class="row">
									<div class="col-xs-3 date">
										<i class="fa fa-comments"></i>12:50 pm<br/>
...
<script type="text/javascript">
	$(document).ready(function() {
		setTimeout(function() {
			...
			toastr.success('CodeInsane Administrator', 'Welcome to INSPINIA');
		}, 1300);
		var data1 = [
