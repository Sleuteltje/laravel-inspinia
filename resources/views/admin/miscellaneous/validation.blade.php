...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li><a>Tables</a></li>
			<li class="active"><strong>Validation</strong></li>
		</ol>
	</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		<div class="col-lg-6">
			<div class="ibox ">
				<div class="ibox-title"><h5>Validation</h5></div>
				<div class="ibox-content">
					<h2>jQuery Validation Plugin - Form validation made easy</h2>
					...
					<form role="form" id="form">
						...
						<div><button class="btn btn-sm btn-primary m-t-n-xs" type="submit"><strong>Submit</strong></button></div>
					</form>
				</div>
			</div>
		</div>
