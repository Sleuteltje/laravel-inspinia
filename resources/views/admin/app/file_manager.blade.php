				...
				<div class="col-lg-12">
					<div class="file-box">
						<div class="file">
							<a href="#">
								...
								<div class="file-name">Document_2014.doc<br/>
					...
					<div class="file-box">
						<div class="file">
							<a href="#">
								<span class="corner"></span>
								<div class="image"><img alt="image" class="img-responsive" src="{{asset('/assets/img/p3.jpg')}}"></div>
								<div class="file-name">Document_2014.doc<br/>
					...
					<div class="file-box">
						<a href="#">
							<div class="file">
								...
								<div class="file-name">Annual report 2014.xls<br/>
