...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-9">
		...
		<ol class="breadcrumb">
			...
			<li>UI Elements</li>
			<li class="active"><strong>Bootstrap Carousel</strong></li>
		</ol>
	</div>
</div>
					...
					<div class="carousel slide" id="carousel3">
						<div class="carousel-inner">
							<div class="item gallery active left">
								<div class="row">
									<div class="col-sm-6"><img alt="image" class="img-responsive" src="{{asset('/assets/img/p_big1.jpg')}}"></div>
									<div class="col-sm-6"><img alt="image" class="img-responsive" src="{{asset('/assets/img/p_big2.jpg')}}"></div>
									<div class="col-sm-6"><img alt="image" class="img-responsive" src="{{asset('/assets/img/p_big3.jpg')}}"></div>
									<div class="col-sm-6"><img alt="image" class="img-responsive" src="{{asset('/assets/img/p_big1.jpg')}}"></div>
								</div>
							</div>
						...
						<a data-slide="prev" href="#carousel3" class="left carousel-control"><span class="icon-prev"></span></a>
						<a data-slide="next" href="#carousel3" class="right carousel-control"><span class="icon-next"></span></a>
					</div>
				</div>
			</div>
		</div>
